...
struct  X509Store_t1371  : public Object_t
{
	...
	X509Certificate2Collection_t1361 * ___list_2;
	...
	X509Store_t1386 * ___store_4;
};
struct X509Store_t1371_StaticFields{
	...
	Dictionary_2_t1025 * ___U3CU3Ef__switch$mapF_5;
};
